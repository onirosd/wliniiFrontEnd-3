            ...
            <w-card>
                ...
                <div class="flex flex-row justify-between flex-wrap m-5">
                    <div class="w-full md:w-1/2 self-center">
                        <p class="subtitle bold tertiary-text text-center md:text-left" >{{ property.price }}</p>
    ...
    methods: {
        ...
        initProperties(){
            ...
            if(_comision){
                ...
                else _comision = parseFloat(this.detail.Num_ComisionCompartir) + '%';
            }else{
                _comision = 0;
            }
...
.moneda-alert{
    background-color: #fbde7f40;
    color: #efc140;
    padding: 3px 10px;
    border-radius: 3px;
    border: 1px solid #ffcc4878;
}
</style>
